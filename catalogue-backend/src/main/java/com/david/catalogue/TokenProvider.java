...
public class TokenProvider {
    ...
    public static final String TOKEN_ISSUER = "catalogue-backend";
    public static final String TOKEN_AUDIENCE = "catalogue-frontend";
    ...
    public String generate(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .claim("accountType", user.getUserRole().name())
                .compact();
    }
